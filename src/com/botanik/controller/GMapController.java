...
//        gmapModel = new GmapModel(Double.NaN, Double.NaN, Double.NaN, Double.NaN, Double.MIN_NORMAL, Double.NaN);
    ...
    public void screenShoot() {
         WritableImage writableImage = 
            new WritableImage((int)dialogStage.getScene().getWidth(), (int)dialogStage.getScene().getHeight()-60);
        dialogStage.getScene().snapshot(writableImage);
        
        gmapModel.setGmapWritableImage(writableImage);
        
        gmapModel.setGmapWritableImage(writableImage);
        
//        addSpecimenController.getGmapModel().setGmapWritableImage(writableImage);
//        BufferedImage image1 = SwingFXUtils.fromFXImage(writableImage, null);
//        Image image =SwingFXUtils.toFXImage(image1, null);
//        addSpecimenController.loadMapImage(image);
//        File file = new File("snapshot.png");
//        try {
//            ImageIO.write(SwingFXUtils.fromFXImage(writableImage, null), "png", file);
//            System.out.println("snapshot saved: " + file.getAbsolutePath());
//            addSpecimenController.setMapFile(file);
...
//    public void initAddSpecimenController(final AddSpecimenController addSpecimenController){
//         takeButton.setOnAction((ActionEvent event) -> {
//             screenShoot();
//             addSpecimenController.setGmapModel(gmapModel);
//         });
//    }
    
    public void setGmapModel(GmapModel gmapModel) {
