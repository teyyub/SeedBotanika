...
public class GmapModel {
    ...
    private WritableImage gmapWritableImage;
    ...
    public GmapModel(Double latitudeDegree,
        ...
        degLatitude = latitudeDegree + latitudeMinute / 60 + latitudeSecond /3600;
        degLongitude = longitudeDegree + longitudeMinute / 60 + longitudeSecond / 3600;
    }
    ...
    public WritableImage getGmapWritableImage() {
        return gmapWritableImage;
    }

    public void setGmapWritableImage(WritableImage gmapWritableImage) {
        this.gmapWritableImage = gmapWritableImage;
    }
